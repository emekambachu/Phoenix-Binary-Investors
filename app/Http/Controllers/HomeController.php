...
class HomeController extends Controller
{
    ...
    public function recoverPassword(Request $request){
        ...
        Mail::send('emails.users.recover-password', $data, static function ($message) use ($data) {
            $message->from('support@phoenixbinaryinvestors.com', 'Phoenix Binary Investors');
            $message->to($data['email'], $data['name']);
            $message->replyTo('support@phoenixbinaryinvestors.com', 'Phoenix Binary Investors');
    ...
    public function contactForm(Request $request){
        ...
        Mail::send('emails.contact-form', $data, static function ($message) use ($data) {
            $message->from('info@bit-farms.ltd', 'Phoenix Binary Investors');
            $message->to('support@phoenixbinaryinvestors.com', 'Phoenix Binary Investors');
            $message->replyTo('noreply@bit-farms.ltd', 'Phoenix Binary Investors');
