                ...
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <div class="card component-card_2 mb-2">
                            ...
                            <img width="200" src="{{ asset("photos/{$address->image}") }}" class="card-img-top" alt="widget-card-2">
                            @endif
                        </div>
                        @endforeach
        ...
        <div class="footer-wrapper">
            <div class="footer-section f-section-1">
                <p class="">Copyright © {{ date('Y') }}
                    <a target="_blank" href="{{ url('/') }}">Phoenix Binary Investors</a>, All rights reserved.</p>
            </div>
        </div>
